...
GameObjectBase::GameObjectBase() : Tanxl_ClassBase("0.4"), _Main_Character(new GameObject(15, 10)) {}
...
{
	for (std::vector<Componment_Base*>::iterator IOCB{ this->_Object_Content.begin() }; IOCB != this->_Object_Content.end(); ++IOCB)//¸ù¾ÝÃû³ÆÉ¾³ý
	{
